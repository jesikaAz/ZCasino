...
# ZCasino, un jeu de roulettes simplifié
...
while continuer_partie: # Tant qu'on doit continuer la partie
    # on demande à l'utilisateur de saisir le nb sur lequel il va miser
    nombre_mise = -1
    while nombre_mise < 0 or nombre_mise > 49:
        nombre_mise = input("Tapez le nombre sur lequel vous voulez miser (entre 0 et 49) : ")
        # On convertit le nb misé
        try:
    ...
    # On sélectionne la somme à miser sur le nb
    mise = 0
    ...
    if numero_gagnant == nombre_mise:
        ...
        print("Désolé, c'est pas pour cette fois. Vous perdez votre mise.")
        argent -= mise
